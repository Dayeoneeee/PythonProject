...
#if 조건문:    동일한 내용으로 여려번 비교 처리할 때
#       조건문이 맞으면 처리
#else if 조건문2:
#       (조건문은 틀리고)조건문2이 맞으면 처리
#else if 조건문3:
...
if a==1: #남자인 경우에만 출력, 여자인 경우는 아무 작업도 안함
    print("입력한 성별은 남자입니다.")
...
if c>=90:   #같은 값으로 여러번 비교할 때는 비교 값이 큰순 또는 작은순으로 정리해서 비교
    print("학점이 A등급입니다.")
elif c>=80:
    print("학점이 B등급입니다.")
elif c>=70:
...
#if문을 연산식으로 구현한 삼항식, 결과가 1행으로 구성되었을 때
#변수 = 조건?참:거짓   ==> java, c++, c#
